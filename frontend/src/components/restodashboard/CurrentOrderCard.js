...
const CurrentOrderCard = (props) => {
    ...
    return (
        ...
        <div className="card h-100" >
            ...
            <button type="button" class="btn btn-dark" onClick={()=>{ConfirmOrder("confirm")}}>Confirm</button>
            &nbsp; &nbsp;<button type="button" class="btn btn-dark" onClick={()=>{ConfirmOrder("cancel")}}>Cancel</button>
